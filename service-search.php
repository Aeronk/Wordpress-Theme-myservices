...
<div class="card">
    ...
    <div class="card-body">
            ...
            <form action="<?php echo home_url('/service-search');?>">
            ...
            <div class="form-group">
                ...
                <select name="service" class="form-control">
                        ...
                        <?php foreach($services as $service):?>
                                ...
                                <?php if(  isset($_GET['service']) && ( $_GET['service'] == $service->slug)  ):?>
                                    selected
                                <?php endif;?>


                                value="<?php echo $service->slug;?>"><?php echo $service->name;?></option>
                        <?php endforeach;?>
            ...
            <a href="<?php echo home_url('service-search');?>">Reset search</a>
